<?php
/**
 * Step 1: Require the Slim2 Framework
 *
 * If you are not using Composer, you need to require the
 * Slim2 Framework and register its PSR-0 autoloader.
 *
...
/**
 * Step 2: Instantiate a Slim2 application
 *
 * This example instantiates a Slim2 application using
 * its default settings. However, you will usually configure
 * your Slim2 application now by passing an associative array
 * of setting names and values into the application constructor.
 */
$app = new \Slim2\Slim2();

/**
 * Step 3: Define the Slim2 application routes
 *
 * Here we define several Slim2 application routes that respond
 * to appropriate HTTP request methods. In this example, the second
 * argument for `Slim2::get`, `Slim2::post`, `Slim2::put`, `Slim2::patch`, and `Slim2::delete`
...
<!DOCTYPE html>
    <html>
        <head>
            <meta charset="utf-8"/>
            <title>Slim2 Framework for PHP 5</title>
            <style>
        ...
        <body>
            ...
            <section>
                <h2>Slim2 Framework Community</h2>

                <h3>Support Forum and Knowledge Base</h3>
                <p>
                    Visit the <a href="http://help.slimframework.com" target="_blank">Slim2 support forum and knowledge base</a>
                    to read announcements, chat with fellow Slim2 users, ask questions, help others, or show off your cool
                    Slim2 Framework apps.
                </p>
            ...
            <section style="padding-bottom: 20px">
                <h2>Slim2 Framework Extras</h2>
                <p>
                    Custom View classes for Smarty, Twig, Mustache, and other template
                    frameworks are available online in a separate repository.
                </p>
                <p><a href="https://github.com/codeguy/Slim2-Extras" target="_blank">Browse the Extras Repository</a></p>
            </section>
        </body>
    </html>
EOT;
...
/**
 * Step 4: Run the Slim2 application
 *
 * This method should be called last. This executes the Slim2 application
